            ...
            <ul class="dropdown-menu entopmenu">
                        <li>
                            <div class="navbar-login">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <p class="text-left"><strong>{{ isset(Auth::user()->getUserProfile()->first_name) ? Auth::user()->getUserProfile()->first_name : Auth::user()->email }} {{ isset(Auth::user()->getUserProfile()->last_name) ? Auth::user()->getUserProfile()->last_name : Auth::user()->email }}</strong></p>
                        ...
                        <li>
                            <div class="navbar-login navbar-login-session">
                                ...
                                <div class="col-lg-6">
                                        <p>
                                            <a href="{{ route('usuarios.edit',Auth::user()->id)}}" class="btn btn-donc-enlaces">Actualizar Datos</a>
                                        </p>
                                    </div>
                                    <div class="col-lg-6">
                                        <p>
