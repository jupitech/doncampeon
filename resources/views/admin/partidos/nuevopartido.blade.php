             ...
             <div class="col-sm-6 spi">
               ...
               <div class="col-sm-12">
                  @include('admin.sections.errors')
             	      <?php
                      $equipos=DB::table('dc_equipos')->leftjoin('ligas_equipos','dc_equipos.id','=','ligas_equipos.equipos_id')->where('ligas_equipos.ligas_id',$laliga)->orderBy('dc_equipos.id','ASC')->select('dc_equipos.nombre_equipo as nombreequipo','dc_equipos.id as elid')->lists('nombreequipo','elid');
                      $nombreliga=Doncampeon\Models\Ligas::where('id',$laliga)->first()->nombre_liga;
                      ?>
                          ...
                          <div class="col-sm-6 spi">
                            ...
                            <div class="col-sm-6 spi">
                                 <div class="form-group">
                                   ...
                                   {!! Form::text('fecha_partido', '',  ['id'=>'datetimepicker2','class'=> 'form-control','placeholder'=>'Ingresa fecha aqui']) !!}
                               ...
                               <div class="col-sm-6 spi">
                                 <div class="form-group">
                                    <label>Hora del partido</label>
                                     {!! Form::text('hora_partido', '',  ['id'=>'datetimepicker3','class'=> 'form-control','placeholder'=>'Ingresa fecha aqui']) !!}
                            ...
                            <div>
                                {!! Form::hidden('liga', $laliga,  ['class'=> 'form-control']) !!}
