          ...
          <ul class="tab_donc nav nav-tabs" role="tablist">
           ...
           <div class="tab-content">
               <div role="tabpanel" class="tab-pane active" id="todos">
                  ...
                  <table id="tabledonc" class="table table-striped dataTable" cellspacing="0" width="100%">
                  	<thead>
                  	<tr>
                  		<th>Equipo</th>
                  		<th>Alias</th>
                ...
                <div role="tabpanel" class="tab-pane" id="nacionales">...</div>
                <div role="tabpanel" class="tab-pane" id="internacionales">...</div>
